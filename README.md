...
| POST | `/products/search` | 製品名でWeb検索・情報取得 | 🔲 未実装 |
| POST | `/routine/suggest` | 気分に合わせたルーティン提案 | 🔲 未実装 |
...
services/
  ...
  routine_suggester.py       # Claude API ルーティン提案（未実装）
data/
...
- [ ] Step 4: Claude API連携（製品検索・ルーティン提案）
